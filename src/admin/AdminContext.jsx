...
const seedOrders = [
  { id: 'ORD-001', customer: 'Victoria Sterling', email: 'victoria@example.com', phone: '+1 212-555-0101', items: [{ productId: 1, name: 'Celestial Diamond Ring', qty: 1, price: 49 }], total: 49, status: 'delivered', date: '2026-08-28', address: '142 Park Ave, New York, NY 10016', trackingNumber: '1Z999AA10123456784', carrier: 'UPS', estimatedDelivery: '2026-08-31', notes: 'Gift wrapped per request', statusHistory: [
  ...
  { id: 'ORD-002', customer: 'Alexander Chen', email: 'alex@example.com', phone: '+1 415-555-0202', items: [{ productId: 2, name: 'Rose Eternity Necklace', qty: 1, price: 59 }], total: 59, status: 'shipped', date: '2026-08-29', address: '88 Mission St, San Francisco, CA 94105', trackingNumber: '9400111899223100001', carrier: 'USPS', estimatedDelivery: '2026-09-02', notes: '', statusHistory: [
  ...
  { id: 'ORD-003', customer: 'Isabella Romano', email: 'isabella@example.com', phone: '+39 02-555-0303', items: [{ productId: 3, name: 'Imperial Sapphire Earrings', qty: 1, price: 89 }, { productId: 6, name: 'Versailles Pearl Earrings', qty: 1, price: 44 }], total: 133, status: 'processing', date: '2026-08-30', address: '55 Via Montenapoleone, Milan 20121', trackingNumber: '', carrier: 'DHL', estimatedDelivery: '2026-09-05', notes: 'International shipment — customs docs attached', statusHistory: [
  ...
  { id: 'ORD-004', customer: 'James Wright', email: 'james@example.com', phone: '+44 20-555-0404', items: [{ productId: 5, name: 'Noir Diamond Pendant', qty: 1, price: 54 }], total: 54, status: 'pending', date: '2026-08-30', address: '10 Downing St, London SW1A 2AA', trackingNumber: '', carrier: '', estimatedDelivery: '', notes: 'Rush order requested', statusHistory: [
    { status: 'pending', date: '2026-08-30T20:15:00', note: 'Order placed — awaiting payment confirmation' },
  ]},
  { id: 'ORD-005', customer: 'Sophie Laurent', email: 'sophie@example.com', phone: '+33 1-555-0505', items: [{ productId: 7, name: 'Aura Emerald Ring', qty: 1, price: 78 }], total: 78, status: 'delivered', date: '2026-08-25', address: '15 Rue du Faubourg Saint-Honoré, Paris 75008', trackingNumber: 'RR123456789FR', carrier: 'La Poste', estimatedDelivery: '2026-08-28', notes: '', statusHistory: [
  ...
  { id: 'ORD-006', customer: 'Marcus Lee', email: 'marcus@example.com', phone: '+65 555-0606', items: [{ productId: 8, name: 'Seraphina Tennis Bracelet', qty: 1, price: 95 }], total: 95, status: 'shipped', date: '2026-08-27', address: '200 Marina Bay, Singapore 018956', trackingNumber: 'SG1234567890', carrier: 'FedEx', estimatedDelivery: '2026-09-01', notes: 'Insured shipment — high value', statusHistory: [
  ...
  { id: 'ORD-007', customer: 'Elena Volkov', email: 'elena@example.com', phone: '+7 495-555-0707', items: [{ productId: 4, name: 'Maison Gold Bracelet', qty: 2, price: 39 }], total: 78, status: 'processing', date: '2026-08-31', address: '42 Tverskaya St, Moscow 125009', trackingNumber: '', carrier: 'DHL', estimatedDelivery: '2026-09-08', notes: '2 units — verify matching finish', statusHistory: [
  ...
  { id: 'ORD-008', customer: 'David Nakamura', email: 'david@example.com', phone: '+81 3-555-0808', items: [{ productId: 9, name: 'Luna Crescent Necklace', qty: 1, price: 52 }], total: 52, status: 'pending', date: '2026-08-31', address: '3-1-2 Ginza, Chuo-ku, Tokyo 104-0061', trackingNumber: '', carrier: '', estimatedDelivery: '', notes: '', statusHistory: [
    { status: 'pending', date: '2026-08-31T22:00:00', note: 'Order placed — pending stock confirmation' },
  ]},
];

const seedCustomers = [
  { id: 1, name: 'Victoria Sterling', email: 'victoria@example.com', phone: '+1 212-555-0101', orders: 3, totalSpent: 165, joined: '2024-03-15' },
  { id: 2, name: 'Alexander Chen', email: 'alex@example.com', phone: '+1 415-555-0202', orders: 2, totalSpent: 113, joined: '2024-06-22' },
  { id: 3, name: 'Isabella Romano', email: 'isabella@example.com', phone: '+39 02-555-0303', orders: 5, totalSpent: 389, joined: '2023-11-08' },
  { id: 4, name: 'James Wright', email: 'james@example.com', phone: '+44 20-555-0404', orders: 1, totalSpent: 54, joined: '2026-08-30' },
  { id: 5, name: 'Sophie Laurent', email: 'sophie@example.com', phone: '+33 1-555-0505', orders: 4, totalSpent: 287, joined: '2024-01-12' },
  { id: 6, name: 'Marcus Lee', email: 'marcus@example.com', phone: '+65 555-0606', orders: 2, totalSpent: 139, joined: '2025-04-18' },
];
