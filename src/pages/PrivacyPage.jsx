...
export default function PrivacyPage() {
  usePageMeta('Privacy Policy', 'How Ethio-Can Gemstones collects, uses, and protects your personal information.');
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        >
          <p className="text-medium-gray font-light leading-relaxed">
            At Ethio-Can Gemstones, we take your privacy seriously. This Privacy Policy explains how we collect, use,
