...
const sections = [
  {
    ...
    body: 'By accessing or using the MJ website, you agree to be bound by these Terms & Conditions. If you do not agree with any part of these terms, you should not use our website or services.',
  },
  {
  ...
  },
  {
    ...
    body: 'All content on this website — including text, graphics, logos, images, and designs — is the property of MJ and protected by copyright and trademark laws. You may not reproduce, distribute, or use our content without written permission.',
  },
  {
    title: '7. Limitation of Liability',
    body: 'To the maximum extent permitted by law, MJ shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our website or products.',
  },
  {
...
export default function TermsPage() {
  usePageMeta('Terms & Conditions', 'The terms governing use of the MJ website and purchase of our products.');
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        >
          <p className="text-medium-gray font-light leading-relaxed">
            These Terms & Conditions govern your use of the MJ website and the purchase of our products.
